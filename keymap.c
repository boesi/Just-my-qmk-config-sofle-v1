...
enum unicode_names {
    U_ß,
		U_L_0, U_L_1, U_L_2, U_L_3, U_L_4, U_L_5, U_L_6, U_L_7, U_L_8, U_L_9,
		U_U_0, U_U_1, U_U_2, U_U_3, U_U_4, U_U_5, U_U_6, U_U_7, U_U_8, U_U_9,
		U_FRAC, U_ALM_EQL
};
 ...
 */
[_NUSY1] = LAYOUT(
  _______, _______, _______, KC_BSLS,   KC_LT,   KC_GT,                       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
 ...
 */
[_NUSY2] = LAYOUT(
    _______, _______, KC_PRGF, KC_PIPE, _______, _______,                         _______, _______, _______, _______, _______, _______,
    _______,  KC_GRV, KC_DEGR, KC_QUES, _______, _______,                         _______, KC_UL_7, KC_UL_8, KC_UL_9, _______, _______,
    KC_UAEQ, KC_PERC, KC_CIRC, KC_UNDS, KC_LDQT, KC_RDQT,                         _______, KC_UL_4, KC_UL_5, KC_UL_6, _______, _______,
    _______, KC_EURO, KC_MPNT, KC_PLUS, _______, _______, _______,       _______, KC_UL_0, KC_UL_1, KC_UL_2, KC_UL_3, _______, _______,
...
[_NUSY3] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______,                         _______, KC_UU_4, KC_UU_5, KC_UU_6, _______, _______,
    _______, _______, _______, _______, _______, _______, _______,       _______, KC_UU_0, KC_UU_1, KC_UU_2, KC_UU_3, _______, _______,
                      _______, _______, _______, _______, _______,       _______, _______, _______, _______, _______
),
/* FN
 * ,-----------------------------------------.                    ,-----------------------------------------.
